...
app()->booted(function () {
    ...
    add_shortcode('blog', __('blog'), __('blog'), function (Shortcode $shortcode) {
        $field = '';
        return Theme::partial('shortcodes.blog', compact('field'));
    });

    shortcode()->setAdminConfig('blog', function (array $attributes) {
        return Theme::partial('shortcodes.blog-admin-config', compact('attributes'));
    });
